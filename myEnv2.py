...
class CustomEnv(gym.Env):
    ...
    def step(self, actions):
        ...
        # Assuming rewards is a list of rewards, one for each robot
        aggregated_reward = sum(rewards)  # Sum is just one way to handle multiple rewards; adjust as needed
        ...
        # Make sure that the aggregated_reward is a float if it isn't already
